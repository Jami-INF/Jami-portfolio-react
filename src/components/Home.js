...
const Home = () => {
    return (
        <div>
            <div className="mb-40 mt-40">
                <div className="flex flex-col md:flex-row items-center"> {/* Added 'items-center' here */}
                    <div className="w-5/6 h-5/6 my-20 md-10 ml-10 md:-pr-32 md:pl-32">
                        ...
                        <h2 className="text-left text-black dark:text-white mt-20 text-4xl">Je suis <strong className="text-slate-700 dark:text-slate-400">développeur Fullstack</strong></h2>
                    </div>
            ...
            <h2 className="text-center text-black dark:text-white mb-10 text-6xl">Qui suis-je ?</h2>
